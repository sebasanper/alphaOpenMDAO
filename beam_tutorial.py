...
if __name__ == "__main__":
    ...
    print( "loading (including self weight of beam): {0:f}pli {1:f}plf".format(loadingPlusBeam, loadingPlusBeam * 12.0))
    print( "loading (not including self weight of beam): {0:f}fpli {1:f}plf".format(loadingNoBeam, loadingNoBeam * 12.0))
    print( "Finished!")
